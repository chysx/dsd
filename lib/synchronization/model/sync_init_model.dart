...
class SyncInitModel extends AbstractSyncDownloadModel{
  SyncInitModel(SyncType syncType) : super(syncType);
  ...
  @override
   ...
   Future clearDB() async {
     ...
     List<Map<String,dynamic>> list = await database.rawQuery("select name from sqlite_master where type = 'table' and name not like '%metadata%'");
