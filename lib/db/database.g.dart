...
class _$DSD_M_DeliveryHeader_Dao extends DSD_M_DeliveryHeader_Dao {
  ...
  final _dSD_M_DeliveryHeaderMapper = (Map<String, dynamic> row) =>
  ...
  Future<List<DSD_M_DeliveryHeader_Entity>> findEntityByCon(
    ...
    return _queryAdapter.queryList(
        'SELECT * FROM DSD_M_DeliveryHeader WHERE ShipmentNo = ? AND AccountNumber = ?',
...
class _$DSD_M_DeliveryItem_Dao extends DSD_M_DeliveryItem_Dao {
  ...
  final _dSD_M_DeliveryItemMapper = (Map<String, dynamic> row) =>
...
class _$DSD_M_ShipmentHeader_Dao extends DSD_M_ShipmentHeader_Dao {
  ...
  final _dSD_M_ShipmentHeaderMapper = (Map<String, dynamic> row) =>
...
class _$DSD_M_ShipmentItem_Dao extends DSD_M_ShipmentItem_Dao {
  ...
  final _dSD_M_ShipmentItemMapper = (Map<String, dynamic> row) =>
...
class _$DSD_M_SystemConfig_Dao extends DSD_M_SystemConfig_Dao {
  ...
  final _dSD_M_SystemConfigMapper = (Map<String, dynamic> row) =>
...
class _$DSD_M_Truck_Dao extends DSD_M_Truck_Dao {
  ...
  final _dSD_M_TruckMapper = (Map<String, dynamic> row) => DSD_M_Truck_Entity(
      row['id'] as int,
      row['TruckCode'] as String,
      row['Type'] as String,
...
class _$DSD_T_DeliveryHeader_Dao extends DSD_T_DeliveryHeader_Dao {
  ...
  final _dSD_T_DeliveryHeaderMapper = (Map<String, dynamic> row) =>
...
class _$DSD_T_DeliveryItem_Dao extends DSD_T_DeliveryItem_Dao {
  ...
  final _dSD_T_DeliveryItemMapper = (Map<String, dynamic> row) =>
...
class _$DSD_T_ShipmentItem_Dao extends DSD_T_ShipmentItem_Dao {
  ...
  final _dSD_T_ShipmentItemMapper = (Map<String, dynamic> row) =>
...
class _$DSD_T_TruckStock_Dao extends DSD_T_TruckStock_Dao {
  ...
  final _dSD_T_TruckStockMapper = (Map<String, dynamic> row) =>
...
class _$DSD_T_TruckStockTracking_Dao extends DSD_T_TruckStockTracking_Dao {
  ...
  final _dSD_T_TruckStockTrackingMapper = (Map<String, dynamic> row) =>
...
class _$DSD_T_Visit_Dao extends DSD_T_Visit_Dao {
  ...
  final _dSD_T_VisitMapper = (Map<String, dynamic> row) => DSD_T_Visit_Entity(
      row['id'] as int,
      row['VisitId'] as String,
      row['ShipmentNo'] as String,
      row['StartTime'] as String,
...
class _$MD_Account_Dao extends MD_Account_Dao {
  ...
  final _mD_AccountMapper = (Map<String, dynamic> row) => MD_Account_Entity(
      row['id'] as int,
      row['Name'] as String,
      row['AccountNumber'] as String,
      row['Owner'] as String,
...
class _$MD_Contact_Dao extends MD_Contact_Dao {
  ...
  final _mD_ContactMapper = (Map<String, dynamic> row) => MD_Contact_Entity(
      row['pid'] as int,
      row['ID'] as String,
...
class _$MD_Dictionary_Dao extends MD_Dictionary_Dao {
  ...
  final _mD_DictionaryMapper = (Map<String, dynamic> row) =>
...
class _$MD_Product_Dao extends MD_Product_Dao {
  ...
  final _mD_ProductMapper = (Map<String, dynamic> row) => MD_Product_Entity(
      row['id'] as int,
      row['ProductCode'] as String,
      row['Name'] as String,
      row['Description'] as String,
