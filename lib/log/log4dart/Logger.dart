...
import 'package:dsd/log/log4dart/appender/ConsoleAppender.dart';
import 'package:dsd/log/log4dart/appender/FileAppender.dart';
...
class LoggerSuper {
  ...
  static final LoggerSuper _singleton = LoggerSuper._internal();

  factory LoggerSuper() {
    return _singleton;
  }

  LoggerSuper._internal();
